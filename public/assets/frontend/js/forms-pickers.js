...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
    ...
    flatpickrRange2 = document.querySelector('#flatpickr-range2'),
    flatpickrRange3 = document.querySelector('#flatpickr-range3'),
  ...
  if (typeof flatpickrRange2 != undefined) {
    flatpickrRange2.flatpickr({
      mode: 'range'
    });
  }
  if (typeof flatpickrRange3 != undefined) {
    flatpickrRange3.flatpickr({
      mode: 'range'
    });
  }
