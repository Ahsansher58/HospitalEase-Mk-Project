...
@section('content')
    ...
    <div class="card">
        <h5 class="card-header">Update Hospitals</h5>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <form id="hospitalProfileForm" method="POST" action="{{ route('update_hospital', ['id' => $hospital_id]) }}"
                novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input class="form-control typeahead" type="email" placeholder="Enter Email" id="email"
                            name="email" value="{{ old('email', $hospital_login->email) }}" autocomplete="off" required />
                    </div>
                    <div class="col-md-6 mb-4">
                        ...
                        <input class="form-control typeahead" type="text" placeholder="Enter mobile" id="mobile"
                            name="mobile" value="{{ old('mobile', $hospital_login->mobile) }}" autocomplete="off"
                            required />
                    </div>
                    <div class="col-md-6 mb-4">
