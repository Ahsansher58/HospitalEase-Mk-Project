<!--HEADER-->
<header class="fixed-top hospital-header" id="header">
    <nav class="navbar navbar-expand-xl" aria-label="Offcanvas navbar large">
        <div class="container position-relative pe-0">
            <a class="navbar-brand me-0 me-sm-4" href="/">
                ...
                <img src="{{ asset('assets/frontend/images/for-hospital-logo.svg') }}" class="img-fluid logo-active"
                    alt="" />
            </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex justify-content-between align-items-center"
                                    ...
                                    <span><img src="{{ asset('assets/frontend/images/icons/file-dollar.svg') }}"
                                            class="me-2" />Dashboard</span> <img
                                        src="{{ asset('assets/frontend/images/icons/chevron-right.png') }}"
                                        class="ms-auto" />
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex justify-content-between align-items-center"
                                    ...
                                    <span> <img src="{{ asset('assets/frontend/images/icons/settings.svg') }}"
                                            class="me-2" />Setting</span> <img
                                        src="{{ asset('assets/frontend/images/icons/chevron-right.png') }}"
                                        class="ms-auto" />
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('hospitals.logout') }}"><img
