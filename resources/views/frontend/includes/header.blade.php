<header class="fixed-top home-header" id="header">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle user-nav" href="#services" data-bs-toggle="dropdown"
                                    ...
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        ...
                                        <circle cx="7.99992" cy="4.66667" r="2.66667" stroke="#242B37"
                                        ...
                                        <path
                                            ...
                                            stroke="#242B37" stroke-opacity="0.9" stroke-width="1.5"
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu ">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('hospital.login') }}">Hospital
                                            Login</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('doctors.login') }}">Doctor Login</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
