            ...
            <div class="d-flex col-lg-9 col-12 align-items-center">
                <div class="w-px-430 mx-auto py-5 px-3">
                    ...
                    <div class="text-center">
                        ...
                        <p>Don’t have an account yet? <a href="{{ route('doctors.register') }}" class="info-link">Sign up
                                now</a></p>
                    ...
                    @endif
                    <form class="needs-validation" action="{{ route('doctors.login.submit') }}" method="POST" novalidate>
                        @csrf
                        <div class="mb-3">
