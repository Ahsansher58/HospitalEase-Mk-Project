...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        <div class="hospital-list-block my-favourite-hospital frame">
                            <h3 class="font-medium">Allergic to Medicine</h3>
                            ...
                            <div class="table-responsive medicine-table">
                                <table id="allergicMedicines" class="table mb-0 medicine-table">
                                    <thead>
                                        <tr>
                                            <th>id</th>
                                            <th>Medicine Name </th>
        ...
        <div class="modal-dialog modal-m modal-dialog-centered">
            <div class="modal-content rounded-24">
                <div class="modal-header border-0">
                    <h3 class="modal-title font-regular" id="staticBackdropLabel">Allergic to Medicine</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body mt-4">
                    <form id="addAllergicMedicine" method="POST" action="{{ route('user.allergicMedicineStore') }}">
                        @csrf
                        <div class="row gy-3">
                            <div class="col-lg-12">
    ...
    <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-m modal-dialog-centered">
            <div class="modal-content rounded-24">
                <div class="modal-header border-0">
                    <h3 class="modal-title font-regular" id="staticBackdropLabel">Edit Allergic to Medicine</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body mt-4">
                    <form id="editForm">
    ...
    <script>
        var table = $('#allergicMedicines').DataTable({
            ajax: {
                url: '{{ route('user.getMedicines') }}',
                dataSrc: 'data'
            },
        ...
        $(document).ready(function() {
            ...
            $('#editForm').on('submit', function(e) {
                ...
                var updateUrl = '{{ route('user.allergicMedicineUpdate', ':id') }}'.replace(':id',
                    medicineId);
        ...
        function edit_popup(medicineId) {
            var editUrl = '{{ route('user.editGetMedicines', ':id') }}'.replace(':id', medicineId);
            $.ajax({
                url: editUrl,
                method: 'GET',
        ...
        function delete_medicine(medicineId) {
            ...
            if (confirm("Are you sure you want to delete this medicine?")) {
                ...
                var deleteUrl = '{{ route('medicine.delete', ':id') }}'.replace(':id', medicineId);
