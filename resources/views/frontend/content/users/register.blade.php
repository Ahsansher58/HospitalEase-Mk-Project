            ...
            <div class="d-flex col-lg-9 col-12 align-items-center">
                <div class="w-px-430 mx-auto py-5 px-3">
                    <div class="text-center">
                        ...
                        <p>Already have an account? <a href="{{ route('users.login') }}" class="info-link">Sign in now</a>
                        </p>
                    ...
                    <form class="needs-validation" action="{{ route('users.register.submit') }}" method="POST" novalidate>
                        @csrf
                        <div class="mb-3">
