...
(function () {
  ...
  const TagifyCustomInlineSuggestionEl2 = document.querySelector('#TagifyCustomInlineSuggestion2');
  const TagifyCustomListSuggestionEl2 = document.querySelector('#TagifyCustomListSuggestion2');
  ...
  // Inline
  let TagifyCustomInlineSuggestion2 = new Tagify(TagifyCustomInlineSuggestionEl2, {
  ...
  const TagifyCustomInlineSuggestionEl3 = document.querySelector('#TagifyCustomInlineSuggestion3');
  const TagifyCustomListSuggestionEl3 = document.querySelector('#TagifyCustomListSuggestion3');
  ...
  // Inline
  let TagifyCustomInlineSuggestion3 = new Tagify(TagifyCustomInlineSuggestionEl3, {
  ...
  const TagifyCustomInlineSuggestionE4 = document.querySelector('#TagifyCustomInlineSuggestion4');
  const TagifyCustomListSuggestionE4 = document.querySelector('#TagifyCustomListSuggestion4');

  const whitelist4 = [
    'Velachery'
  ];
  // Inline
  let TagifyCustomInlineSuggestion4 = new Tagify(TagifyCustomInlineSuggestionE4, {
